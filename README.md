...
**👉 [打开网页版](https://famalhaut04.github.io/canvas-weekly-hub/web/)**

输入你的 Canvas 令牌，页面直接生成你的专属课程看板：待办倒计时、提交状态、新课件清单、历史归档、跨周搜索，并可下载「我的学习网站.html」离线使用、订阅手机日历提醒（截止前 2 小时）。

- 数据只保存在你自己的浏览器里，随时一键清除
- 因学校未开放 Canvas 跨域，需先部署一个**只属于你的免费转发代理**：点页面里的「一键部署到 Cloudflare」，登录后约 2 分钟完成，令牌不经过任何人

详细步骤见 **[网页版使用指南](docs/网页版使用指南.md)**
